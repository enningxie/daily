	...
	for t in range(100):
		...
		for j in range(len(rows)):
			...
			for i in range(k):
				...
				if d<distance(clusters[besmatch],row):
					besmatch = i
				bestmatches[besmatch].append(j)
		# 如果结果与上一次相同，则整个过程结束
